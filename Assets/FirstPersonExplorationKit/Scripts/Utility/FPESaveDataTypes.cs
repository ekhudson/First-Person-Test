...
namespace Whilefun.FPEKit
{
    ...
    public class FPEDoorSaveData
    {
        ...
        private string objName;
        public string ObjectName { get { return objName; } }
        private FPESimpleDoor.eDoorState state;
        public FPESimpleDoor.eDoorState DoorState { get { return state; } }
        private string doorHandleString;
        public string DoorHandleString { get { return doorHandleString; } }

        public FPEDoorSaveData(string objectName, FPESimpleDoor.eDoorState doorState, string handleString)
        {
            objName = objectName;
            state = doorState;
        ...
        public override string ToString()
        {
            return "FPEDoorSaveData: name='"+ objName + "',state='"+state+"',handleString='"+doorHandleString+"'";
        }
