...
namespace Whilefun.FPEKit
{
    ...
    public class FPESaveLoadManager : MonoBehaviour
    {
        ...
        private void initialize()
        {
            ...
            if (editorDebugKeys)
            {
                Debug.LogWarning("FPESaveLoadManager:: Debug keys active! 1: Quick Save 2: Quick Load 4: Delete Saved Game File. To disable, uncheck the 'Editor Debug Keys' checkbox in the inspector of object '" + gameObject.name+"'");
            }
#endif
